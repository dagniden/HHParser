...
def test_init_creates_file(test_filename: str) -> None:
    """Тест: инициализация создает файл"""
    JSONStorage(test_filename)
    assert os.path.exists(test_filename)


def test_init_with_existing_file(test_filename: str) -> None:
...
def test_read_returns_data(test_filename: str, sample_vacancy: Vacancy) -> None:
...
def test_update_nonexistent_vacancy(test_filename: str, sample_vacancy: Vacancy) -> None:
...
def test_delete_nonexistent_vacancy(test_filename: str, sample_vacancy: Vacancy) -> None:
...
def test_data_persistence(test_filename: str, sample_vacancy: Vacancy) -> None:
